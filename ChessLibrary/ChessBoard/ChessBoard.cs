...
public partial class ChessBoard
{
    ...
    public List<string> FenHistory { get; } = [];
    ...
    /// </summary>
    public bool StandardiseCastlingPositions { get; set; }
    ...
    /// </summary>
    public ChessBoard(Piece?[,] pieces, List<Move> moves)
    {
    ...
    /// <summary>
    /// Undo last displayed move (if possible) without modifying the executed moves history.
    /// </summary>
    public void Undo()
    {
        if (moveIndex < 0)
    ...
    /// <summary>
    /// Redo next move (if possible) without modifying the executed moves history.
    /// </summary>
    public void Redo()
    {
        if (moveIndex >= executedMoves.Count - 1)
            return;
